...
export default function ServiceArea() {
    ...
    return (
        <div className="flex flex-col items-center justify-center py-12 px-8 gap-2 bg-brand-silver">
            <h2 className="font-bold text-2xl text-center">Located in {address}</h2>
            <h3 className="font-semibold text-center">Serving all of {serviceArea} and Easten Middlesex and Northern Ocean Counties</h3>
            <div className="flex flex-col md:flex-row text-center py-12 px-8 gap-8 w-full">
                <div className="flex flex-col bg-white md:w-1/3 p-8 rounded-2xl border-brand-blue border-2 gap-4">
